...
namespace __Interop
{
	...
	{
		// Signature, crc32, [fwd] [return] [EETypeRva:0x000419B0] uint__unsigned int, [fwd] [in] [EETypeRva:0x000419B0] uint__unsigned int, [fwd] [in] [EETypeRva:0x000419B0] byte___ptrunsigned char *, [fwd] [in] [EETypeRva:0x000419B0] int__int, 
		[global::System.Runtime.InteropServices.McgPInvokeMarshalStub("System.IO.Compression, Version=4.2.1.0, Culture=neutral, PublicKeyToken=b77a5c561934e089", "Interop+zlib", "crc32")]
					...
					int len)
		{
			...
			// Marshalling
			// Call to native method
			unsafe___value = global::__Interop.clrcompression_dll_PInvokes.crc32(
								crc, 
								((byte*)buffer), 
								len
							);
	...
	public unsafe static partial class clrcompression_dll_PInvokes
	{
		...
		public extern static uint crc32(
					uint crc, 
					byte* buffer, 
					int len);
