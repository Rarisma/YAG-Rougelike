...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "YetAnotherGenericRougelikeGame.Android.dll" comes first in this list. */
		"YetAnotherGenericRougelikeGame.Android.dll",
		"FormsViewGroup.dll",
		...
		"YetAnotherGenericRougelikeGame.dll",
	};
